...
4. **Adversarial Spoofing & Continuous Testing:** Chen, Xin, & Phoha (`Chen2024`, [10.1109/TBIOM.2024.3369590](https://doi.org/10.1109/TBIOM.2024.3369590)) formulated sequential hypothesis testing for continuous behavioral authentication, establishing mathematical boundaries to resist adversarial mimicry.
5. **Defending VR Behavioral Biometrics Against Forecasting Attacks:** Li, Banerjee, & Banerjee (`Li2026`, [10.3389/frvir.2026.1766672](https://doi.org/10.3389/frvir.2026.1766672)) developed defenses against synthetic trajectory prediction and motion forecasting attacks in immersive systems.
6. **Head Movement Continuous Biometrics:** Gyreyiri & Shukla (`Gyreyiri2025`, [10.1145/3756884.3768408](https://doi.org/10.1145/3756884.3768408)) demonstrated sub-5% EER continuous user authentication leveraging high-frequency 6-DoF head rotational dynamics.
...
Using `telemetry/biometric_eer_eval.py`, the system was evaluated for a collaborative enterprise deploying 1,200 active VR design engineering stations:
...
4. L. Chen, Y. Xin, and V. V. Phoha, "SSPRA: A Robust Approach to Continuous Authentication Amidst Real-World Adversarial Challenges," *IEEE Trans. Biom., Behav., Identity Sci.*, vol. 6, no. 2, pp. 248-261, 2024. DOI: [10.1109/TBIOM.2024.3369590](https://doi.org/10.1109/TBIOM.2024.3369590).
5. Z. Li, N. Banerjee, and S. Banerjee, "Real or fake motion: protecting virtual reality (VR) behavioral authentication systems against motion forecasting attacks," *Front. Virtual Real.*, vol. 7, art. no. 1766672, 2026. DOI: [10.3389/frvir.2026.1766672](https://doi.org/10.3389/frvir.2026.1766672).
6. K. Gyreyiri and S. Shukla, "Head Movement Biometrics for Continuous Authentication in Virtual Reality," in *Proc. 2025 31st ACM Symp. Virtual Reality Software and Technology (VRST '25)*, 2025. DOI: [10.1145/3756884.3768408](https://doi.org/10.1145/3756884.3768408).
